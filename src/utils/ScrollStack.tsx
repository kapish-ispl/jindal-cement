...
export const ScrollStackItem = ({ children, itemClassName = '' }: ScrollStackItemProps): React.JSX.Element => (
...
const ScrollStack = ({
    ...
    onStackComplete
}: ScrollStackProps): React.JSX.Element => {
    ...
    // Cache for static offsets to avoid feedback loops with transforms
    ...
    const measureOffsets = useCallback(() => {
        ...
        // Temporarily reset transforms to get accurate static offsets
        ...
        if (endElement) {
            ...
            endElementOffsetRef.current = endRect.top + scrollTop;
        }
    ...
    const updateCardTransforms = useCallback(() => {
        ...
        cardsRef.current.forEach((card, i) => {
            ...
            if (hasChanged) {
                const transform = `translate3d(0, ${newTransform.translateY.toFixed(2)}px, 0) scale(${newTransform.scale}) rotate(${newTransform.rotation}deg)`;
