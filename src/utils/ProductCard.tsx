...
const ProductCard: React.FC<ProductCardProps> = ({ postData, itemsPerPage = 9, totalPost }) => {
                ...
                <div className="row gy-2">
                    <div className="col-md-10 col-12">
                        <div className="input-group">
                            <input type="text" className="form-control" placeholder="Search our Products" aria-label="Search" aria-describedby="awards search" />
                    ...
                    <div className="c-cardView__wrapper">
                        <Link className="cursor-pointer" href="#">
                            <span className="c-cardView__wrapper-media">
                                <img alt={post?.title} className="img-fluid u-img" src={post?.media?.[0]?.cdnPath} />
                            </span>
                            <span className="c-cardView__wrapper-content">
                                <span className="title">{post?.title}</span>
                            </span> <span className="c-cardView__wrapper-shape"></span>
                        </Link>
                    </div>
                </div>
            ))}
